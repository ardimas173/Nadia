...
<div class="spp20162017-form">
    ...
    <?= $form->field($model, 'debit_julli_15')->textInput(['maxlength' => 100]) ?>

    <?= $form->field($model, 'tanggal_bayar_agustus_15')->textInput() ?>

    <?= $form->field($model, 'debit_agustus_15')->textInput(['maxlength' => 100]) ?>

    <?= $form->field($model, 'tanggal_bayar_sept_15')->textInput() ?>

    <?= $form->field($model, 'spp_sept_15')->textInput(['maxlength' => 100]) ?>
