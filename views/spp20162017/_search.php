...
/* @var $model app\models\Spp20162017Search */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="spp20162017-search">
    ...
    <?php // echo $form->field($model, 'debit_julli_15') ?>

    <?php // echo $form->field($model, 'tanggal_bayar_agustus_15') ?>

    <?php // echo $form->field($model, 'debit_agustus_15') ?>

    <?php // echo $form->field($model, 'tanggal_bayar_sept_15') ?>

    <?php // echo $form->field($model, 'spp_sept_15') ?>
