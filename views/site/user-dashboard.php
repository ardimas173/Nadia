        ...
        <div class="callout callout-info msg-of-day">
            ...
            <p>
                <marquee onmouseout="this.setAttribute('scrollamount', 6, 0);"
                         onmouseover="this.setAttribute('scrollamount', 0, 0);" scrollamount="6" behavior="scroll"
                         direction="left"><?= $stuMsg->msg_details; ?></marquee>
            </p>
        </div>
    <?php endif; ?>
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    <h3>
                        <?= app\modules\student\models\StuMaster::find()->where(['is_status' => 0,'stu_master_batch_id'=>Batches::findActive()])->count(); ?>
                    </h3>
                    <p>
        ...
        <section class="col-lg-7 connectedSortable">
            ...
            <div class="nav-tabs-custom"><!-- .nav-tabs-custom -->
                ...
                <ul class="nav nav-tabs pull-right">
                    ...
                    <li class="active"><a href="#all-notice"
                                          data-toggle="tab"><?php echo Yii::t('app', 'General') ?></a></li>
                    <li class="pull-left header" style="<?= (Yii::$app->language == 'ar') ? 'left:35%' : ''; ?>"><i
                            class="fa fa-inbox"></i><?php echo Yii::t('app', 'Notice Board') ?></li>
                </ul>
                                ...
                                <div class="notice-main bg-light-blue">
                                    <div class="notice-disp-date">
                                        <small class="label label-success"><i
                                                class="fa fa-calendar"></i> <?= (!empty($nl->notice_date) ? Yii::$app->formatter->asDate($nl->notice_date) : "Not Set"); ?>
                                        </small>
                                    </div>
                                    <div class="notice-body">
                                        <div
                                            class="notice-title"><?= Html::a($nl->notice_title, '#', ['style' => 'color:#FFF', 'class' => 'noticeModalLink', 'data-value' => Url::to(['dashboard/notice/view-popup', 'id' => $nl->notice_id])]); ?>
                                            &nbsp; </div>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title <?= (Yii::$app->language == 'ar') ? 'pull-right' : '' ?>"><i
                            class="fa fa-calendar"></i> <?php echo Yii::t('app', 'Calendar') ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <!--The calendar -->
                    <?php
...
EOF;
                    ...
                    <div class="row">
                        <ul class="legend">
                            ...
                            <li><span class="importantnotice"></span> <?php echo Yii::t('app', 'Important Notice') ?>
                            </li>
        ...
        <section class="col-lg-5 connectedSortable">
            ...
            <div class="nav-tabs-custom"><!-- .nav-tabs-custom -->
                ...
                <ul class="nav nav-tabs pull-right">
                    ...
                    <li class="active"><a href="#birth-taday"
                                          data-toggle="tab"><?php echo Yii::t('app', "Today's") ?></a></li>
                    <li class="pull-left header" style="<?= (Yii::$app->language == 'ar') ? 'left:26%' : ''; ?>"><i
                            class="fa fa-birthday-cake"></i><?php echo Yii::t('app', 'Birthdays') ?></li>
                </ul>
                <div class="tab-content">
                    <!-- Birthdays -->
                                ...
                                <div class="box box-solid bg-aqua">
                                    <div class="box-header">
                                        <div class="pull-left" style="padding:5px">
                                            <img src="<?= $el->getEmpPhoto($el->emp_photo); ?>" class="img-circle"
                                                 alt="no image" width="40px" height="40px">
                                        </div>
                                        <h3 class="box-title"><?php echo $el->getEmpName(); ?>&nbsp;
                                            <small class="label label-success"><i
                                                    class="fa fa-calendar"></i> <?php echo date('d M', strtotime($el->emp_dob)); ?>
                                            </small>
                                        </h3>
                                    </div>
                                </div><!-- /.box -->
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title <?= (Yii::$app->language == 'ar') ? 'pull-right' : ''; ?>"><i
                            class="ion ion-university"></i> <?php echo Yii::t('app', 'Courses') ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <ul class="todo-list" id="coursList">
                        ...
                        foreach ($courseList as $cl) :
                            ...
                            <li>
                                ...
                                <?php $stuCount = app\modules\student\models\stuMaster::find()->where(['stu_master_course_id' => $cl->course_id, 'is_status' => 0,'stu_master_batch_id'=>Batches::findActive()])->count(); ?>
                                <span
                                    class="notification-container <?= (Yii::$app->language == 'ar') ? 'pull-left' : 'pull-right'; ?> text-teal"
                                    title="<?= $stuCount; ?> Students"><i class="fa fa-users"></i><span
                                        class="label label-info notification-counter"><?= $stuCount; ?></span></span>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div><!-- /.box-body -->
