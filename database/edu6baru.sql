...
--
-- Host: localhost
-- Generation Time: Feb 27, 2017 at 04:14 AM
...
(1, 'SD', 'SD', 'SD', '2017-02-25 19:41:57', 1, NULL, NULL, 0);
...
(11, 1, 1, '2017-02-25 18:40:00', NULL, '::1'),
(12, 1, 1, '2017-02-25 18:47:26', NULL, '::1'),
(13, 1, 1, '2017-02-25 18:49:02', NULL, '::1'),
(14, 1, 1, '2017-02-25 18:49:12', NULL, '::1');
...
(1, 'SD 1', 1, NULL, '2017-02-25 19:41:57', 1, NULL, NULL, 0);
...
(2, 2, 'Amrizal', '', 'JJ', '', 'MALE', '2017-02-25', 'asdf@asdf.com', 'Unknown', 'd', 'Kristen', '2017-02-25', NULL, NULL, 234, 2, ''),
(3, 3, 'klsdjfg', '', 'dsklfjgh', '', '@@@@', '2017-02-25', 'dsfgdsfg@asdfgsd.com', 'Unknown', 'dsfg', 'Kristen', '2017-02-25', NULL, NULL, 345, 3, ''),
(4, 4, 'anak baru', '', 'lkasjdf', '', '@@@@', '2017-02-25', 'aasdfsdf@asdf.com', 'Unknown', 'asdf', 'Kristen', '2017-02-25', NULL, NULL, 123, 4, '');
...
(2, 2, NULL, NULL, NULL, 2, 2, 3, 0, 2, '2017-02-25 19:06:36', 1, NULL, NULL, 0),
(3, 3, NULL, NULL, NULL, 2, 2, 2, 0, 3, '2017-02-25 19:18:44', 1, NULL, NULL, 0),
(4, 4, NULL, NULL, NULL, 2, 2, 2, 0, 4, '2017-02-25 19:31:57', 1, NULL, NULL, 0);
...
--
ALTER TABLE `fees_payment_transaction`
  MODIFY `fees_pay_tran_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `login_details`
  MODIFY `login_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `stu_address`
  MODIFY `stu_address_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `stu_docs`
  MODIFY `stu_docs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `stu_info`
  MODIFY `stu_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `stu_master`
--
ALTER TABLE `stu_master`
  MODIFY `stu_master_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
