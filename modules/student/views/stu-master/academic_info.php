...
<div class="col-xs-12">
    <div class="col-lg-8 col-sm-8 col-xs-12 no-padding edusecArLangCss"><h3 class="box-title"><i
                class="fa fa-edit"></i> <?= Html::encode($this->title) ?> </h3>
    </div>
            ...
            <div class="box box-solid box-info col-xs-12 col-lg-12 no-padding">
                ...
                <div class="box-body">
                    <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
                        ...
                        <div class="col-xs-12 col-sm-6 col-lg-6">
                            <?= $form->field($model, 'stu_master_section_id')->dropDownList(ArrayHelper::map(Section::find()->where(['section_course_id' => $model->stu_master_course_id, 'is_status' => 0])->all(), 'section_id', 'section_name'), ['' => Yii::t('stu', '--- Select Section ---')]); ?>
                        </div>
                    </div>
