...
class StuInfo extends \yii\db\ActiveRecord
{
    ...
    public static function getReligionOptions()
    {
        return [
            ...
            Yii::t('stu', self::TYPE_PROTESTAN) => Yii::t('stu', 'Kristen'),
            Yii::t('stu', self::TYPE_KATOLIK) => Yii::t('stu', 'Khatolik'),
        ];
    }
