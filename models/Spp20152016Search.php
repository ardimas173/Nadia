...
/**
 * Spp20152016Search represents the model behind the search form about `app\models\Spp20152016`.
 */
class Spp20152016Search extends Spp20152016
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'tanggal_bayar_september_15' => $this->tanggal_bayar_september_15,
        ...
        $query->andFilterWhere(['like', 'no_induk', $this->no_induk])
            ...
            ->andFilterWhere(['like', 'spp_september_15', $this->spp_september_15])
