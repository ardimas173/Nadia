...
/**
 * This is the model class for table "spp20152016".
 *
 ...
 * @property string $tanggal_bayar_september_15
 * @property string $spp_september_15
 ...
 */
class Spp20152016 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['no_induk', 'nama', 'section', 'course', 'course_alias', 'tahun_ajaran', 'debit_juli_15', 'debit_agustus_15', 'spp_september_15', 'spp_oktober_15', 'spp_november_15', 'spp_desember_15', 'spp_januari_16', 'spp_februari_16', 'spp_maret_16', 'spp_april_16', 'spp_mei_16', 'spp_juni_16'], 'required'],
            [['no_induk'], 'string'],
            [['tahun_ajaran'], 'integer'],
            [['tanggal_bayar_juli_15', 'tanggal_bayar_agustus_15', 'tanggal_bayar_september_15', 'tanggal_bayar_oktober_15', 'tanggal_bayar_november_15', 'tanggal_bayar_desember_15', 'tanggal_bayar_januari_16', 'tanggal_bayar_februari_16', 'tanggal_bayar_maret_16', 'tanggal_bayar_april_16', 'tanggal_bayar_mei_16', 'tanggal_bayar_juni_16'], 'safe'],
            [['nama', 'debit_juli_15', 'debit_agustus_15', 'spp_september_15', 'spp_oktober_15', 'spp_november_15', 'spp_desember_15', 'spp_januari_16', 'spp_februari_16', 'spp_maret_16', 'spp_april_16', 'spp_mei_16', 'spp_juni_16'], 'string', 'max' => 100],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tanggal_bayar_september_15' => 'Tanggal Bayar September 15',
            'spp_september_15' => 'Spp September 15',
